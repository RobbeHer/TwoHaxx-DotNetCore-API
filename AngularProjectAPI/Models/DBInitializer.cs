    ...
    public class DBInitializer
    {
        public static void Initialize(TwoHaxxContext context)
        {
            ...
            context.Talks.AddRange(
                    ...
                    new Talk { Name = "Talk 2", Description = "Description talk 2", StartDate = new DateTime(), EndDate = new DateTime(), TalkerID = 3, ModeratorID = 4, RoomID = 1 },
                    new Talk { Name = "Talk 3", Description = "Description talk 3", StartDate = new DateTime(), EndDate = new DateTime(), TalkerID = 3, ModeratorID = 4, RoomID = 1 },
                    new Talk { Name = "Talk 4", Description = "Description talk 4", StartDate = new DateTime(), EndDate = new DateTime(), TalkerID = 3, ModeratorID = 4, RoomID = 1 },
                    new Talk { Name = "Talk 1", Description = "Description talk 1", StartDate = new DateTime(), EndDate = new DateTime(), TalkerID = 3, ModeratorID = 4, RoomID = 2 },
                    new Talk { Name = "Talk 2", Description = "Description talk 2", StartDate = new DateTime(), EndDate = new DateTime(), TalkerID = 3, ModeratorID = 4, RoomID = 2 }
                );
            ;
            context.SaveChanges();
